...
import com.baizeli.eternisstarrysky.cora.utils.Helper;
...
public class LNGService implements ITransformationService {
    static {
        ...
        newMap.put("LNGPlusLegacy", new LNGPlusLaunchPluginService());
        if (plugins != null)
    ...
    public static void makeMyModLoadable() {
        ...
        try {
            ...
            completedLayers.values().forEach((layerInfo) -> {
                ...
                String moduleName = LNGService.class.getModule().getName();
