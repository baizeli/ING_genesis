...
public class SpellAttributesRegistry {
    ...
    public static final RegistryObject<Attribute> FIRE_SPELL_PENETRATION;
    public static final RegistryObject<Attribute> HOLY_SPELL_PENETRATION;
    public static final RegistryObject<Attribute> ICE_SPELL_PENETRATION;
    public static final RegistryObject<Attribute> BLOOD_SPELL_PENETRATION;
    ...
    public static final RegistryObject<Attribute> ELDRITCH_SPELL_PENETRATION;
    ...
    static {
        ...
        // 烈焰法术穿透
        FIRE_SPELL_PENETRATION = ATTRIBUTES.register("fire_spell_penetration", () -> (new MagicPercentAttribute(
            "attribute." + Genesis.MOD_ID + ".fire_spell_penetration",
            1.0, 0, 2
        )).setSyncable(true));
        ...
        // 冰霜法术穿透
        ICE_SPELL_PENETRATION = ATTRIBUTES.register("ice_spell_penetration", () -> (new MagicPercentAttribute(
            "attribute." + Genesis.MOD_ID + ".ice_spell_penetration",
            1.0, 0, 2
        )).setSyncable(true));
        
        // 猩红法术穿透
        BLOOD_SPELL_PENETRATION = ATTRIBUTES.register("blood_spell_penetration", () -> (new MagicPercentAttribute(
            "attribute." + Genesis.MOD_ID + ".blood_spell_penetration",
            1.0, 0, 2
        )).setSyncable(true));
        ...
        // 邪术法术穿透
        ELDRITCH_SPELL_PENETRATION = ATTRIBUTES.register("eldritch_spell_penetration", () -> (new MagicPercentAttribute(
            "attribute." + Genesis.MOD_ID + ".eldritch_spell_penetration",
            1.0, 0, 2
        )).setSyncable(true));
