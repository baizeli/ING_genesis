...
public class LightningBoltRenderer extends EntityRenderer<LightningBolt> {
    ...
    private static void quad(Matrix4f matrix, VertexConsumer consumer, float x1, float z1, int index, float x2, float z2, float red, float green, float blue, float alpha, float p_115283_, float p_115284_, boolean p_115285_, boolean p_115286_, boolean p_115287_, boolean p_115288_) {
        consumer.vertex(matrix, x1 + (p_115285_ ? p_115284_ : -p_115284_), (float)(index * 16), z1 + (p_115286_ ? p_115284_ : -p_115284_)).color(red, green, blue, alpha).endVertex();
        consumer.vertex(matrix, x2 + (p_115285_ ? p_115283_ : -p_115283_), (float)((index + 1) * 16), z2 + (p_115286_ ? p_115283_ : -p_115283_)).color(red, green, blue, alpha).endVertex();
        consumer.vertex(matrix, x2 + (p_115287_ ? p_115283_ : -p_115283_), (float)((index + 1) * 16), z2 + (p_115288_ ? p_115283_ : -p_115283_)).color(red, green, blue, alpha).endVertex();
