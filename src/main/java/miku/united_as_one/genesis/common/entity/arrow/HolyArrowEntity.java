...
public class HolyArrowEntity extends Entity {
    ...
    private static final EntityDataAccessor<Boolean> DYING = SynchedEntityData.defineId(HolyArrowEntity.class, EntityDataSerializers.BOOLEAN);

    public HolyArrowEntity(EntityType<? extends HolyArrowEntity> entityType, Level level) {
        super(entityType, level);
    }

    public HolyArrowEntity(Level level, LivingEntity shooter, double baseDamage) {
        super(EntityRegistry.HOLY_ARROW.get(), level);
