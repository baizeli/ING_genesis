...
public class ConfigValue
{
    ...
    public ConfigValue(AbstractContainerEventHandler parent, String key, Font font)
    {
        ...
        this.text.alignLeft();
        this.reset = Button.builder(Component.literal("⟲"), this::onReset)
    ...
    public void draw(GuiGraphics graphics, int x, int y, int mouseX, int mouseY)
    {
        ...
        this.mouseX = mouseX;
        this.mouseY = mouseY;
        int textColor = this.hoverText() ? COLOR_HOVER : COLOR_DEFAULT;
        if (!this.active)
        ...
        if (this.description != null && this.hoverText()) {
            graphics.renderTooltip(this.font, this.description, mouseX, mouseY);
        }
    }
    ...
    public boolean matchesSearch(String query) {
        ...
        return this.key.toLowerCase().contains(lowerQuery) ||
                (this.tooltip != null && this.tooltip.getString().toLowerCase().contains(lowerQuery)) ||
                (this.description != null && this.description.getString().toLowerCase().contains(lowerQuery));
    }
}
