...
public class EntityUtil {
    public static void killEntity(Entity entity) {
        ...
        entity.entityData.set(LivingEntity.DATA_HEALTH_ID, 0.0F);
        ...
        if (entity.level instanceof ServerLevel serverLevel) {
            ...
            PhoenixEntityTickList entityTickList = new PhoenixEntityTickList();
            serverLevel.entityTickList.forEach(entityTickList::add);
            ...
            var visibleEntityStorage = new PhoenixEntityLookup();
            ...
            var sectionStorage = new PhoenixEntitySectionStorage(serverLevel.entityManager.sectionStorage);
            ...
            serverLevel.entityManager.entityGetter = new PhoenixLevelEntityGetterAdapter(visibleEntityStorage, sectionStorage);
        ...
        if (entity.level instanceof ClientLevel clientLevel) {
            PhoenixEntityTickList tickingEntities = new PhoenixEntityTickList();
            clientLevel.tickingEntities.forEach(tickingEntities::add);
            ...
            var sectionStorage = new PhoenixEntitySectionStorage(clientLevel.entityStorage.sectionStorage);
            sectionStorage.removeEntity(entity);

            clientLevel.entityStorage.entityStorage = visibleEntityStorage;
            clientLevel.entityStorage.sectionStorage = sectionStorage;
            clientLevel.entityStorage.entityGetter = new PhoenixLevelEntityGetterAdapter(visibleEntityStorage, sectionStorage);
    ...
    private static class PhoenixEntityTickList extends EntityTickList {
    ...
    private static class PhoenixEntityLookup extends EntityLookup<Entity> {
    ...
    private static class PhoenixEntitySectionStorage extends EntitySectionStorage<Entity> {
        public PhoenixEntitySectionStorage(EntitySectionStorage<Entity> sectionStorage) {
    ...
    private static class PhoenixLevelEntityGetterAdapter extends LevelEntityGetterAdapter<Entity> {
        private final PhoenixEntityLookup visibleEntities;
        private final PhoenixEntitySectionStorage sectionStorage;

        public PhoenixLevelEntityGetterAdapter(PhoenixEntityLookup visibleEntityStorage, PhoenixEntitySectionStorage sectionStorage) {
