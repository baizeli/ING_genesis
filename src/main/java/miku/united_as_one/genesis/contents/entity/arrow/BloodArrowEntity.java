...
public class BloodArrowEntity extends Entity {
    ...
    private static final EntityDataAccessor<Boolean> DYING = SynchedEntityData.defineId(BloodArrowEntity.class, EntityDataSerializers.BOOLEAN);

    public BloodArrowEntity(EntityType<? extends BloodArrowEntity> entityType, Level level) {
        super(entityType, level);
    }

    public BloodArrowEntity(Level level, LivingEntity shooter, double baseDamage) {
        super(EntityRegistry.BLOOD_ARROW.get(), level);
