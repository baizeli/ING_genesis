...
public class StellarArrowEntity extends Entity {
    ...
    private static final EntityDataAccessor<Boolean> DYING = SynchedEntityData.defineId(StellarArrowEntity.class, EntityDataSerializers.BOOLEAN);

    public StellarArrowEntity(EntityType<? extends StellarArrowEntity> entityType, Level level) {
        super(entityType, level);
    }

    public StellarArrowEntity(Level level, LivingEntity shooter, double baseDamage) {
        super(EntityRegistry.STELLAR_ARROW.get(), level);
