...
public final class ModUpgradeOrbTypeProvider {
    ...
    static void bootstrap(BootstapContext<UpgradeOrbType> context) {
        ...
        type(UpgradeOrbTypes.IEC_SPELL_PENETRATION)
    ...
    private static final class UpgradeOrbTypeBuilder {
        ...
        private UpgradeOrbTypeBuilder amount(double amount) {
            this.amount = amount;
            return this;
        }

        @SuppressWarnings("unused")
        private UpgradeOrbTypeBuilder operation(AttributeModifier.Operation operation) {
