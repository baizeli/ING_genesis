...
public class RightSwordAnimation {
    ...
    public static void onRenderHand(RenderHandEvent event) {
        ...
        if (/*item.getItem() instanceof DivineMetalSword ||
            item.getItem() instanceof MithrilSword ||*/
            item.getItem() instanceof VioletSword
        ) {
            ...
            else if (item.getItem() instanceof DivineMetalSword) poseStack.translate(side * 0.7, -0.5, -0.8);
            else if (item.getItem() instanceof VioletSword) poseStack.translate(side * 0.7, -0.5, -0.8);
            else poseStack.translate(side * 0.7, -0.5, -0.8);
