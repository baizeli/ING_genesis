...
public class HolyArrowRenderer extends EntityRenderer<HolyArrowEntity> {
    ...
    private static final ResourceLocation TRAIL_TEX_1 = ResourceLocation.tryBuild(Genesis.MOD_ID, "textures/images/trail_holy.png");
    ...
    @Override
    public void render(HolyArrowEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    private void renderTrail(HolyArrowEntity entity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer) {
    ...
    private float[] calculateFlowingColor(float progress, float time) {
        ...
        return TrailHelp.interpolateGradientColor(colorPosition, ColorHelper.HOLY_THEME);
    }

    @Override
    public ResourceLocation getTextureLocation(HolyArrowEntity entity) {
