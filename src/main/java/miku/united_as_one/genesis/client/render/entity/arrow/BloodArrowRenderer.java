...
public class BloodArrowRenderer extends EntityRenderer<BloodArrowEntity> {
    ...
    private static final ResourceLocation TRAIL_TEX_1 = ResourceLocation.tryBuild(Genesis.MOD_ID, "textures/images/trail_blood.png");
    ...
    @Override
    public void render(BloodArrowEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    private void renderTrail(BloodArrowEntity entity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer) {
    ...
    private float[] calculateFlowingColor(float progress, float time) {
        ...
        return TrailHelp.interpolateGradientColor(colorPosition, ColorHelper.BLOOD_THEME);
    }

    @Override
    public ResourceLocation getTextureLocation(BloodArrowEntity entity) {
