...
public class BloodTentacleEmissiveLayer extends GeoRenderLayer<VoidTentacle> {
    public static final ResourceLocation TEXTURE =  new ResourceLocation(Genesis.MOD_ID, "textures/entity/blood_tentacle/blood_tentacle_emissive.png");

    public BloodTentacleEmissiveLayer(GeoEntityRenderer entityRendererIn) {
